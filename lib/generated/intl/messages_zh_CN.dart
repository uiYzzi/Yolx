...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "URLTextBox": MessageLookupByLibrary.simpleMessage(
            "添加多个下载链接时，请确保每行只有一个链接（支持磁力链、Flashget://、qqdl://和thunder://）"),
        ...
        "dropTorrent":
            MessageLookupByLibrary.simpleMessage("拖动torrent/metalink文件到此或点击打开"),
        ...
        "savedSuccessfully": MessageLookupByLibrary.simpleMessage("已成功保存首选项"),
        "setsAnOverrideForTheAppsPreferredLanguage":
            MessageLookupByLibrary.simpleMessage("设置应用程序首选语言的覆盖"),
        "setsDownloadProxyServer":
            MessageLookupByLibrary.simpleMessage("设置下载代理服务器"),
        "setsTheDisplayModeOfTheNavigationPane":
            MessageLookupByLibrary.simpleMessage("设置导航窗格的显示模式"),
        "setsTheRPCOfTheApplication":
            MessageLookupByLibrary.simpleMessage("设置应用程序的RPC"),
        "setsTheStyleOfTheNavigationIndicator":
            MessageLookupByLibrary.simpleMessage("设置导航指示器的样式"),
